...
class DatosOtra
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Cita::class, mappedBy="datos_otro_reserva")
     */
    private $citas;
    ...
    public function removeCita(Cita $cita): self
    {
        if ($this->citas->removeElement($cita)) {
            ...
            if ($cita->getDatosOtroReserva() === $this) {
                $cita->setDatosOtroReserva(null);
            }
        }
